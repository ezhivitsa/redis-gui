...
export class MenuBuilder {
      ...
      submenu: [
        {
          label: 'Learn More',
          click() {
            shell.openExternal('https://github.com/ezhivitsa/redis-gui');
          },
        },
      ],
    };
  ...
  buildDefaultTemplate(): (MenuItem | MenuItemConstructorOptions)[] {
